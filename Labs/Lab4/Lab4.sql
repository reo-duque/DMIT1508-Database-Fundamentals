...
-- Drop Tables
Drop Table if exists  HighPassengerCount
...
Create Table HighPassengerCount
(
	LogID						int				Identity(1,1)
												Not Null
												Constraint PK_HighPassengerCount_LogID Primary Key,
	LogDate						smalldatetime	Not Null,
	ConfirmationNumber			char(11)		Not Null,
	NewPassengerCount			int				Not Null,
	OldPassengerCount			int				Not Null
)
Go
...
Values
	...
	('F4D4-4096-A', 'ACA874-24DEC-2104', '7b33b45a-f4d4-4096-a934-b96524818df9', 'Micheline', '', 'Casarella', '1-639-592-8802', Null, 'M.Casarella@zmail.co', '11619 69 Street NW', 'Kalispell', Null, 'United States', 6)
Go
...
Values
	...
	('3E38-4463-A', 1, 'Inigo', 'Mandy', 'Montoya', '1-474-337-7977', 'April 1, 1966'),
	...
	('F4D4-4096-A', 1, 'Ralph', '', 'Ellison', '1-236-407-1742', 'Jan 31, 1985'),
	('F4D4-4096-A', 2, 'Miles', '', 'Ellison', NULL, 'Nov 5, 1980'),
	('F4D4-4096-A', 3, 'Debbie', '', 'Ellison', NULL, 'Dec 7, 1952'),
	('F4D4-4096-A', 4, 'Colton', '', 'Ellison', NULL, 'May 19, 1982'),
	('F4D4-4096-A', 5, 'Mariah', '', 'Ellison', NULL, 'May 19, 1982'),
	('F4D4-4096-A', 6, 'Amelia', '', 'Ellison', NULL, 'May 19, 1982')
Go
